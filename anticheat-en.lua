...
local function HandleViolation(player, reason, value)
	...
	local dmgEmbed = {
		...
		["description"] = emoji.bell .. " **" .. player.Name .. "** detected with suspicious movements!" .. string.char(10,10) ..
			emoji.uye .. " **Player:** " .. player.Name .. " (" .. player.UserId .. ")" .. string.char(10) ..
			emoji.pause .. " **Cheat Type:** " .. reason .. string.char(10) ..
			emoji.event .. " **Detail:** " .. value .. string.char(10) ..
