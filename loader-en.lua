-- ========== LIVE ANTI-CHEAT LOADER (English) ==========
-- YOU CAN EDIT:
...
local success, response = pcall(function()
    return HttpService:GetAsync("https://liveac-api.onrender.com/anticheat?key=" .. LICENSE_KEY .. "&lang=en&obfuscate=true")
end)
...
print("[Live Anti-Cheat] Anti-Cheat started")
